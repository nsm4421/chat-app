...
import 'supabase_chat_data_source_handler.dart';
...
class SupabaseChatMessageDataSourceImpl
  ...
  static const _chatMessageReactionsTable = 'chat_message_reactions';
  ...
  static const _messageOverviewColumns =
      ...
      'sender_display_name, sender_username, sender_avatar_url, like_count, is_liked_by_me';
  ...
  @override
  Future<ChatMessageOverviewModel> like({required String chatMessageId}) {
    return guardChatRequest(() async {
      final currentUserId = requireCurrentUserId(_client);

      await _client
          .from(_chatMessageReactionsTable)
          .upsert(
            {
            ...
            onConflict: 'chat_message_id,user_id,reaction',
            ignoreDuplicates: true,
          );

      return _getMessageOverview(chatMessageId);
    });
  }

  @override
  Future<ChatMessageOverviewModel> unlike({required String chatMessageId}) {
    return guardChatRequest(() async {
      final currentUserId = requireCurrentUserId(_client);
