...
class _EditProfileViewState extends State<_EditProfileView> {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocListener<ProfileEditCubit, ProfileRequestState>(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Card(
                    child: Padding(
                      padding: 20.p,
                      child: BlocBuilder<ProfileEditCubit, ProfileRequestState>(
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              DebouncedFilledButton(
                                onPressed: requestState.isLoading || !canSubmit
                                    ? null
                                    : _submit,
                                child: Text(
